...
def ventana1():
    ...
    option1 = tk.Button(root, bg=btn1, fg='white', text='Biodegradable', padx=20, pady=10,
                        command=lambda: biodegradable(root))
...
def ventana3():
    ...
    option2 = tk.Button(root, bg=btn2, fg='white', text='Sin Funcion', padx=20, pady=10,
                        command=lambda: sinfuncion(root))
